...
function Employee(name, email, hireDate) {
 ...
 let bob =  new Employee('Bob', 'bob@gmail.com', '01-02-98');
  ...
  /*
    Write a constructor function, including method definitions, which will make the above function 
  ...
  */
  ...
  /*
    Here we have a constructor function named Movie that takes in 3 parameters:
      name (a string), genre (a string), and rating (a number withing 1-100 that has been averaged 
        out from previous given ratings).
 ...
 Movie.prototype.changeRating = function(num){
  ...
  // Write a constructor function called User. This function should take in 4 parameters 
  // called name, age, email, and savedPosts in that order. Name and email will be strings, 
  // age will be a number and savedPosts will be an array of objects. These objects will each have 
  // 3 properties: id (a number), title (a string), and rating (a number between 1 and 5). These objects 
  // are the posts that the user will have saved to their account.
  
  // // Once the User constructor function is created, write a prototype method for the User function.
  //  Name this method addSavedPost. It should take in three parameters: id (a number), title (a string)
  //   and rating (a number). Use these parameters to create a new object and add it to the savedPosts array.
  ...
  // will take in one number parameter representing the post id. Use this id to find and remove the matching
  //  object in the savedPosts array.
  ...
  // // Write a prototype method for the User constructor function named changePostRating that will take 
  // in two number parameters. The first will be an id (a number) and the second will be the new rating 
  // (a number). Use the id to find the matching object in the savedPosts array. Once you find the matching object, 
